...
while True:
	...
	for i in range(len(bboxes)):
		...
		x,y,w,h = rect
		croped = image_opencv[y:y+h, x:x+w].copy()
		## (2) make mask
		...
		###############################
		#cv2.putText(image_opencv, 'ciao', (bboxes[i][0][0],bboxes[i][0][1]), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (36,255,12), 2)
